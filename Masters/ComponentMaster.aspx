<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMaster.master" AutoEventWireup="true" CodeFile="ComponentMaster.aspx.cs" Inherits="Masters_ComponentMaster" %>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                ...
                <div class="container-fluid px-3">
                    ...
                    <div class="row">
                        <div class="col-md-10">
                            <h4 class="mt-4">&nbsp <b>ROW MATERIAL MASTER</b></h4>
                        </div>
                        ...
                        <div class="card-body ">
                            <div class="row">
                                ...
                                <div class="col-md-6 col-12 mb-3">
                                    <label for="lblComponentname" class="form-label LblStyle"><span class="spncls">*</span>Row Material Name : </label>
                                ...
                                <div class="col-md-6 col-12 mb-3">
                                    <label for="lblComponentcode" class="form-label LblStyle"><span class="spncls">*</span>Row Material Code :</label>
