<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMaster.master" AutoEventWireup="true" CodeFile="PaintingPage.aspx.cs" Inherits="Production_PaintingPage" %>
                        ...
                        <div class="col-md-11">
                            <div style="background-color: #fefefe; width: 562px; height: 560px; padding: 18px 7px; border: 3px solid black;">
                                <div style="background-color: #01a9ac; height: 52px; width: 539px; margin-top: -15px;">
                                    <h4 style="padding: 8px; color: #fff;">Send to Fibraction 
