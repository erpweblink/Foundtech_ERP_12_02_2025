<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProdDTLSProjCodeWise.aspx.cs" Inherits="Production_ProdDTLSProjCodeWise" %>
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                    <div class="container-fluid px-4">
                        <div class="row">
                            <asp:HiddenField runat="server" ID="hideJobCode" />
                            <br />
