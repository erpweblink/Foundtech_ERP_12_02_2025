<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/LaxmiMaster.master" CodeFile="DefectOutward.aspx.cs" Inherits="Laxshmi_DefectOutward" %>
                ...
                <div class="container-fluid px-4">
                    ...
                    <div class="row">
                        <div class="col-9 col-md-10">
                            <h4 class="mt-4 ">DEFECT OUTWARD</h4>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-3">
                        ...
                        <%--               <div class="col-md-3">
                            <div style="margin-top: 14px;">
                                <asp:Label ID="Label2" Font-Bold="true" runat="server" Text="Inward Number :"></asp:Label>
                        ...
                        <div class="col-md-3">
                            <div style="margin-top: 14px;">
                                <asp:Label ID="Label3" Font-Bold="true" runat="server" Text="Reason :"></asp:Label>
                                <asp:TextBox ID="txtReason" CssClass="form-control" placeholder="Search Reason " runat="server" OnTextChanged="txtReason_TextChanged" Width="100%" AutoPostBack="true"></asp:TextBox>
                                <asp:AutoCompleteExtender ID="AutoCompleteExtender4" runat="server" CompletionListCssClass="completionList"
                                    CompletionListHighlightedItemCssClass="itemHighlighted" CompletionListItemCssClass="listItem"
                                    CompletionInterval="10" MinimumPrefixLength="1" ServiceMethod="GetReasonList"
                    ...
                    <div class="row">
                        <div class="col-xl-4 col-md-4" style="text-align: left">
                          ...
                          <asp:Button ID="btnouward" OnClick="btnouward_Click" CssClass="btn btn-primary" runat="server" Text="Defect Outward" Style="padding: 8px;" />--%>
                        </div>
                                ...
                                <asp:GridView ID="GVfollowup" runat="server" CellPadding="4" Font-Names="Verdana" ShowFooter="true"
                                    ...
                                    <Columns>
                                        ...
                                        <%--  <asp:TemplateField HeaderText="Inward No" HeaderStyle-CssClass="gvhead" ItemStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                <asp:Label ID="lblDEFID" runat="server" Visible="false" Text='<%#Eval("ID")%>'></asp:Label>                                             
                                            </ItemTemplate>
                                            <FooterTemplate>
                                            </FooterTemplate>
                                        </asp:TemplateField>--%>
                                        ...
                                        <asp:TemplateField HeaderText="Reason" HeaderStyle-CssClass="gvhead">
                                            <ItemTemplate>
                                                <asp:Label ID="lblDefectType" runat="server" Text='<%#Eval("DefectType")%>'></asp:Label>
                                            </ItemTemplate>
                                            <FooterTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Defect Qty" HeaderStyle-CssClass="gvhead">
                                            <ItemTemplate>
                                                <asp:Label ID="lbldDefectQty" runat="server" Text='<%#Eval("DefectQty")%>'></asp:Label>
                                            </ItemTemplate>
                                            <FooterTemplate>
