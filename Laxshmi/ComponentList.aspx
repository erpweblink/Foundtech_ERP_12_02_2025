<%@ Page Title="" Language="C#" MasterPageFile="~/LaxmiMaster.master" AutoEventWireup="true" CodeFile="ComponentList.aspx.cs" Inherits="Laxshmi_ComponentList" %>
                ...
                <div class="container-fluid px-4">
                    ...
                    <div class="row">
                        <div class="col-9 col-md-10">
                            <h4 class="mt-4 ">&nbsp <b>MATERIAL LIST</b></h4>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            ...
                            <div>
                                <asp:TextBox ID="txtcomponent" CssClass="form-control" placeholder="Search Material" runat="server" OnTextChanged="txtcomponent_TextChanged" Width="100%" AutoPostBack="true"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" Display="Dynamic" ErrorMessage="Please Enter Material Name"
                                ...
                                <div class="table ">
                                    <asp:GridView ID="GVComponentlist" runat="server" CellPadding="4" DataKeyNames="id" PageSize="10" AllowPaging="true" Width="100%"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Material Code" HeaderStyle-CssClass="gvhead">
                                                <ItemTemplate>
                                                    <asp:Label ID="ComponentCode" runat="server" Text='<%#Eval("ComponentCode")%>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Material Name" HeaderStyle-CssClass="gvhead">
                                                <ItemTemplate>
